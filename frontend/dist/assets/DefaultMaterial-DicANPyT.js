const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RealisticTree.glsl-B3w8Ch5U.js","assets/index-BmLEEvs7.js","assets/index-DtrVk80V.css","assets/HUDMaterial.glsl-CBedlSrB.js","assets/vec3f32-WCVSSNPR.js","assets/OutputColorHighlightOID.glsl-CRUtlnL8.js","assets/Indices-Bsyj34Q0.js","assets/BufferView-DDEXIOdU.js","assets/renderState-CKc66y4x.js","assets/glsl-B5bJgrnA.js","assets/frustum-Cxjg2A43.js","assets/orientedBoundingBox-OuzjVt34.js","assets/computeTranslationToOriginAndRotation-BZJpG-XG.js","assets/VertexAttributeLocations-BfZbt_DV.js","assets/VertexElementDescriptor-BLyltQyJ.js","assets/InterleavedLayout-BXo5lbO6.js","assets/types-BKo2foNY.js","assets/ShaderBuilder-dtjY1CNT.js"])))=>i.map(i=>d[i]);
import{lN as ze,c2 as x,lx as k,c9 as $e,nG as et,dp as At,gk as Gt,l1 as Dt,eP as V,lu as jt,BO as Bt,uG as Ht,no as Wt,BP as tt,L as c,M as H,P as at,BQ as kt,BR as Ut,nF as Q,eW as ot,nw as Fe,lG as De,ls as Yt,qk as qt,BS as U,_ as he,fm as rt,np as ne,b5 as re,d2 as Zt,d4 as Xt,bx as Jt,ac as Kt,mT as Qt,cG as ea,tW as z,gn as ta,l5 as aa,cn as oa,cx as ra,eM as be,eB as ia,eJ as je,eA as na,lv as sa,c4 as la}from"./index-BmLEEvs7.js";import{a6 as E,i as me,d as pe,a7 as I,a as it,a8 as fe,a9 as nt,aa as st,ab as ca,ac as W,ad as da,ae as ua,af as ha,f as ma,ag as J,r as O,a2 as ae,D as A,E as G,ah as D,G as K,b as y,I as j,ai as pa,H as fa,aj as va,ak as lt,q as se,al as ct,o as dt,am as ut,g as ga,j as Ne,k as ve,s as ht,an as xa,ao as ba,u as wa,v as Be,ap as ya,aq as _,ar as Oe,as as Ma,at as Ta,c as ee,au as _a,W as oe,av as Sa,M as Ca,aw as mt,ax as le,F as pt,L as ft,K as vt,ay as gt,J as xt,Q as za,U as $a,N as Fa,O as Na,P as Oa,R as Ia,V as La,X as Va,T as Ea,Y as Ra,x as m,A as Pa,az as we,aA as ye,a1 as Aa,aB as Ga,B as Da,aC as ja,a3 as Ba,aD as Ha}from"./OutputColorHighlightOID.glsl-CRUtlnL8.js";import{t as Ce,Q as Ie}from"./InterleavedLayout-BXo5lbO6.js";import{t as i,n as p}from"./glsl-B5bJgrnA.js";import{s as S,T as bt,g as ce,I as He}from"./BufferView-DDEXIOdU.js";import{r as Wa}from"./VertexBuffer-D7pc1zH1.js";import{s as ge}from"./ShaderBuilder-dtjY1CNT.js";import{T as Le,d as Ve,_ as ka}from"./renderState-CKc66y4x.js";import{t as Ua}from"./VertexAttributeLocations-BfZbt_DV.js";function xe(a,e){switch(a.fragment.code.add(i`vec3 screenDerivativeNormal(vec3 positionView) {
...
gl_FragDepth = _linearDepth;
  ...
  `)}function Ct(a,e){const{vertex:t,fragment:o,varyings:r}=a,{hasColorTexture:s,alphaDiscardMode:d}=e,n=s&&d!==1,{output:l,normalType:u,hasColorTextureTransform:f}=e;switch(l){case 2:A(t,e),a.include(G),o.include(j,e),a.include(D,e),n&&o.uniforms.add(new y("tex",v=>v.texture)),t.main.add(i`vpos = getVertexInLocalOriginSpace();
...
forwardTextureCoordinates();`),a.include(B,e),o.main.add(i`
        ...
        ${p(n,i`vec4 texColor = texture(tex, ${f?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}`);break;case 4:case 5:case 6:case 7:case 10:A(t,e),a.include(G),a.include(D,e),a.include(K,e),a.include(co,e),o.include(j,e),a.include(fa,e),va(a),r.add("depth","float",{invariant:!0}),n&&o.uniforms.add(new y("tex",v=>v.texture)),t.main.add(i`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
...
forwardObjectAndLayerIdColor();`),a.include(B,e),o.main.add(i`
        ...
        ${l===10?i`outputObjectAndLayerIdColor();`:i`outputDepth(depth);`}`);break;case 3:{A(t,e),a.include(G),a.include(xe,e),a.include(wt,e),a.include(D,e),a.include(K,e),n&&o.uniforms.add(new y("tex",M=>M.texture)),u===2&&r.add("vPositionView","vec3",{invariant:!0});const v=u===0||u===1;t.main.add(i`
        ...
        fragColor = vec4(0.5 + 0.5 * normal, 1.0);`);break}case 9:A(t,e),a.include(G),a.include(D,e),a.include(K,e),n&&o.uniforms.add(new y("tex",v=>v.texture)),t.main.add(i`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
...
}`)):a.vertex.code.add(i`void forwardNormalUV(){}`)}function Do(a,e){e.hasEmissionTextureTransform&&e.textureCoordinateType!==0?(a.varyings.add("emissiveUV","vec2"),a.vertex.uniforms.add(new I("emissiveTextureTransformMatrix",t=>t.emissiveTextureTransformMatrix??U)).code.add(i`void forwardEmissiveUV(){
...
return mix(mrr, vec3(0.0, 1.0, 0.04), snow);
}`))}function Ho(a){const e=new ge,{attributes:t,vertex:o,fragment:r,varyings:s}=e,{output:d,normalType:n,offsetBackfaces:l,spherical:u,snowCover:f,pbrMode:v,textureAlphaPremultiplied:M,instancedDoublePrecision:C,hasVertexColors:g,hasVertexTangents:F,hasColorTexture:N,hasNormalTexture:Y,hasNormalTextureTransform:R,hasColorTextureTransform:P}=a;if(A(o,a),t.add("position","vec3"),s.add("vpos","vec3",{invariant:!0}),e.include(K,a),e.include(_t,a),e.include(mt,a),e.include(Ao,a),!oe(d))return e.include(Ct,a),e;e.include(Go,a),e.include(Do,a),e.include(jo,a),e.include(Bo,a),le(o,a),e.include(xe,a),e.include(G);const L=n===0||n===1;return L&&l&&e.include(Mt),e.include(ho,a),e.include(wt,a),e.include(Tt,a),s.add("vPositionLocal","vec3"),e.include(D,a),e.include(St,a),e.include(pt,a),o.uniforms.add(new ft("externalColor",b=>b.externalColor,{supportsNaN:!0})),s.add("vcolorExt","vec4"),e.include(vt,a),o.include(fe),o.include(gt),e.include(C?Nt:Ot,a),o.main.add(i`
  ...
  `);const{hasColorTexture:M,hasColorTextureTransform:C}=a;return e.include(zt,a),r.include(Re,a),e.include(B,a),r.include(j,a),e.include(xt,a),le(r,a),ue(r),Ae(r),Ge(r),r.uniforms.add(o.uniforms.get("localOrigin"),o.uniforms.get("view"),new ee("ambient",g=>g.ambient),new ee("diffuse",g=>g.diffuse),new O("opacity",g=>g.opacity),new O("layerOpacity",g=>g.layerOpacity)),M&&r.uniforms.add(new y("tex",g=>g.texture)),e.include($t,a),r.include(Pe,a),r.include(Lt),r.include(Vt,a),te(r),r.main.add(i`
      discardBySlice(vpos);
      discardByTerrainDepth();
